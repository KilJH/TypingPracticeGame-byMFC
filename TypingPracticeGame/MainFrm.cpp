...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//도킹팬 생성
	if (!m_paneOption.Create(_T("옵션"), this, CRect(0, 0, 200, 200), TRUE, 0xfafa,
	...
	m_paneOption.SetMinSize(400);

	m_paneOption.EnableDocking(CBRS_ALIGN_RIGHT|CBRS_ALIGN_LEFT);
	DockPane(&m_paneOption);
